...
public class LegSolver {
    ...
    public final void update(TowerEntity entity, float scale) {
        this.update(entity, entity.yBodyRot, scale);
    }

    public final void update(TowerEntity entity, float yaw, float scale) {
    ...
    public static final class Leg {
        ...
        public void update(TowerEntity entity, double sideX, double sideZ, double forwardX, double forwardZ, float scale) {
        ...
        protected float settle(TowerEntity entity, double x, double y, double z, float height) {
            BlockPos pos = new BlockPos((int) x, (int) (y + 1e-3), (int) z);
